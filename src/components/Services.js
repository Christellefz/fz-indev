  ...
  return (
    <div className='services-container'>
      <p className='first-comment'>
        ...
        tranquille. En matière de communication et de stratégie digitale ma mission
      ...
      <section className='services-section'>
        ...
        <div className='services-section-1st'>
          ...
          <article className='services-article'>
            <ul className='services-dev list'>
              <li className='list-item'>Stratégie Marketing Digital</li>
              <li className='list-item'>Référencement naturel</li>
              <li className='list-item'>Réseaux sociaux</li>
              <li className='list-item'>Création de contenu</li>
